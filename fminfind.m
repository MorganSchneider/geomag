function [x,fval,exitflag,output] = fminfind(funfcn,x,options,varargin)
...
for j = 1:n
    ...
    v(:,j+1) = y;
    x(:) = y;
    fv(two2np1,1) = funfcn(x,varargin{:}); %I EDITED THIS
end
